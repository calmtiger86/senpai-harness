...
누구나 초보시절은 있습니다. 그때 우리가 선배들에게 자주 들었던 말이 있죠. "모르는 물어보면서 해. 그런데 이런것 까지 하나하나 알려줘야 해?"

센빠이 하네스는 모를 것 같은걸 먼저 물어봐주고, 결정된 내용을 친절하게 알려준 뒤 작업에 들어 갑니다. 현실에는 없던 그런 이상적인 선배의 역할을 센빠이 하네스는 해줍니다.

바이브코딩을 처음 접하는 비개발자에게 가장 친절한 센빠이 하네스.

Senpai Harness는 먼저 묻고, 쉽게 설명하고, 함께 결정하고, **승인된 범위만** 만들고, 모든 결정과 실패를 Obsidian(마크다운 메모 앱)에 남기는 AI 선배 하네스입니다. Claude Code(터미널에서 쓰는 AI 코딩 도구)에 설치하는 플러그인입니다.
